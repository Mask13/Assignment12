# 📦 Assignment 12 - User registration and Login
...
[happymask13/assignment11](https://hub.docker.com/repository/docker/happymask13/assignment12/general)

To pull and run the image:
```bash
docker pull happymask13/assignment12:latest
docker run -p 8000:8000 happymask13/assignment12:latest
```
